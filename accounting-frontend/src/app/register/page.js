          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full ${inputPadNoEye} py-3 rounded-lg border border-gray-200 bg-gray-50 text-sm text-gray-800 placeholder-gray-400 outline-none focus:ring-2 focus:ring-[#1b2b6b]/25 focus:border-[#1b2b6b] transition`}
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full ${inputPad} py-3 rounded-lg border bg-gray-50 text-sm text-gray-800 placeholder-gray-400 outline-none focus:ring-2 transition ${
              ...
              {form.confirm && form.confirm === form.password && (
                <span
                  className={`absolute ${isRtl ? "left-10" : "right-10"} top-1/2 -translate-y-1/2 text-green-500`}
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
